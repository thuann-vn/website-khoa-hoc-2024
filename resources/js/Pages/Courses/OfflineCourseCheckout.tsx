...
export default function CheckoutPage({
  ...
  const _submit = (e: { preventDefault: () => void }) => {
    e.preventDefault();
    post(route('offline-courses-checkout-store', {slug: course.slug}),{
      data: data
    });
  }
  ...
  return (
    <>
      ...
      <Guest>
        <BreadCrumb title="Đăng ký lớp học offline" text={course.name} />
                ...
                <div className="row pl--50 pl_md--0 pl_sm--0">
                  ...
                  <div className="plceholder-button">
                    ...
                    <span className="icon-reverse-wrapper">
                      <span className="btn-text">Đăng ký lớp học Offline</span>
