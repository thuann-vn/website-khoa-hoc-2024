        ...
        <div className="inner-wrapper">
            ...
            <ul className="navbar-top-left rbt-information-list justify-content-start">
              <li>
                <Link href={`mailto:${site_settings.email}`}>
                  <i className="feather-mail"></i> {site_settings.email}
                </Link>
              </li>
              <li>
                <Link href={`tel:${site_settings.phone}`}>
                  <i className="feather-phone"></i>{site_settings.phone}
                </Link>
              </li>
            </ul>
          </div>
          ...
          <div className="mobile-menu-bottom">
            ...
            <div className="social-share-wrapper">
              <span className="rbt-short-title d-block">Mạng xã hội</span>
              <ul className="social-icon social-default transparent-with-border justify-content-center mt--20">
                <li>
                  <Link href={site_settings.facebook}>
                    <i className="feather-facebook"></i>
                  </Link>
                </li>
                <li>
                  <Link href={site_settings.zalo}>
                    <svg style={{ width: "22px", height: "22px" }} xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
